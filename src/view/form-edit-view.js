...
function createFormEditTemplate(event = null) {
  const defaultEvent = {
    type: 'flight',
  ...
  const { type, destination, dateFrom, dateTo, basePrice, id } = currentEvent;
  const destinationName = destination ? destination.name : 'Chamonix';
